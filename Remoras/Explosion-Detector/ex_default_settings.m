...
parm.durLong_s = .55; % Durations >= durAfter_s (s) will be eliminated.
parm.durShort_s = 0.03; % Durations >= dur_s (s) will be eliminated.


parm.baseDir = 'E:\Site\data\df20'; % Example base directory.
parm.outDir = 'E:\Site\ExplosionDetections'; % Example output directory.
currentPath = mfilename('fullpath');
templateFilePath = fileparts(currentPath);
parm.templateFile = fullfile(templateFilePath,'ex_template.mat'); % Searches current path of remora for the template!
